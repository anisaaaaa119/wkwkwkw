    ...
    <header class="bg-gray-800 p-3 md:p-4 flex justify-between items-center fixed w-full top-0 z-50 shadow-lg">
        <div class="flex items-center">
            ...
            <div>
                ...
                <span class="hidden md:block text-gray-300 text-xs">Sistem Management Aset Perusahaan</span>
            </div>
        </div>
    ...
    <main class="flex-grow pt-20 md:pt-24">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between">
                    <div class="md:w-1/2 mb-10 md:mb-0 text-center md:text-left">
                        ...
                        <p class="text-gray-600 text-base md:text-lg mb-8">
                            Platform manajemen aset perusahaan yang modern, efisien, dan mudah digunakan untuk memantau semua inventaris Anda dalam satu tempat.
                        </p>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-xl p-6 text-center transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl shadow-md">
                        ...
                        <p class="text-gray-600">Dapatkan laporan dan statistik secara real-time untuk memantau keadaan inventaris perusahaan.</p>
                    </div>
                    <!-- Feature 3 -->
                    <div class="bg-white rounded-xl p-6 text-center transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl shadow-md">
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4">
                ...
                <p class="text-center text-gray-600 mb-12 max-w-2xl mx-auto">Sistem kami mendukung berbagai program keahlian di perusahaan Anda</p>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-left">
                <div>
                    ...
                    <p class="text-gray-400 mb-4">Platform manajemen inventaris barang modern untuk perusahaan- perusahaan di Indonesia.</p>
            ...
            <div class="border-t border-gray-700 pt-6">
                <p class="text-gray-400 text-sm md:text-base"> ©2025 Inventaris Barang. All rights reserved.</p>
